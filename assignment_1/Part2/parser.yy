...
%type <Node*> root Goal MainClass ClassDeclaration VarDeclaration MethodDeclaration Type Statement Expression Identifier
...
MainClass:
  PUBLIC CLASS Identifier LCURLY PUBLIC STATIC VOID MAIN LP STRING LBRACKET RBRACKET Identifier RP LCURLY Statement StatementList RCURLY RCURLY{
    ...
    // Add the identifier to the MainClass node
...
MethodParameterList:
  ...
  | Type Identifier {
    ...
    // Add the identifier to the MethodParameterList node
    $$->children.push_back($2);
  }
  | MethodParameterList COMMA Type Identifier {
    // Create a new node for MethodParameterList
    $$ = $1;
...
MethodDeclaration:
  PUBLIC Type Identifier LP MethodParameterList RP LCURLY MethodBody RETURN Expression SEMICOLON RCURLY {
    ...
    // Add the identifier to the MethodDeclaration node
    $$->children.push_back($3);
...
Statement:
  LCURLY StatementList RCURLY {
    ...
    // Add all statements from StatementList as children
    $$ ->children.push_back($2);
  }
