...
# if 201103L <= YY_CPLUSPLUS
  ...
  private:
    ...
    INT_ARRAY = 265,               // INT_ARRAY
    SYSTEM_OUT_PRINTLN = 266,      // SYSTEM_OUT_PRINTLN
    PUBLIC = 267,                  // PUBLIC
    CLASS = 268,                   // CLASS
    STATIC = 269,                  // STATIC
    VOID = 270,                    // VOID
    ...
    struct symbol_kind
    {
      enum symbol_kind_type
      {
        ...
        S_INT_ARRAY = 10,                        // INT_ARRAY
        S_SYSTEM_OUT_PRINTLN = 11,               // SYSTEM_OUT_PRINTLN
        S_PUBLIC = 12,                           // PUBLIC
        S_CLASS = 13,                            // CLASS
        S_STATIC = 14,                           // STATIC
        S_VOID = 15,                             // VOID
        ...
        S_ClassDeclarationList = 47,             // ClassDeclarationList
        S_ClassDeclaration = 48,                 // ClassDeclaration
        S_VarDeclarationList = 49,               // VarDeclarationList
        S_VarDeclaration = 50,                   // VarDeclaration
        S_NoSemiVarDeclaration = 51,             // NoSemiVarDeclaration
        S_MethodParameterList = 52,              // MethodParameterList
        S_MethodBody = 53,                       // MethodBody
        S_MethodDeclarationList = 54,            // MethodDeclarationList
        S_MethodDeclaration = 55,                // MethodDeclaration
        S_Type = 56,                             // Type
        S_StatementList = 57,                    // StatementList
        S_Statement = 58,                        // Statement
        S_ArgumentList = 59,                     // ArgumentList
        S_ExplicitArgumentList = 60,             // ExplicitArgumentList
...
switch (yykind)
    ...
    // Implementation of make_symbol for each token kind.
      ...
      static
      symbol_type
      make_INT_ARRAY (std::string v)
      {
        return symbol_type (token::INT_ARRAY, std::move (v));
      }
#else
      static
      symbol_type
      make_INT_ARRAY (const std::string& v)
      {
        return symbol_type (token::INT_ARRAY, v);
      }
#endif
#if 201103L <= YY_CPLUSPLUS
      static
      ...
      static
      symbol_type
      make_LCURLY (const std::string& v)
      {
      ...
      static
      symbol_type
      make_RCURLY (const std::string& v)
      {
